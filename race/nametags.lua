...
addEvent('onServerSendsPlayerCountry', true)
addEventHandler('onServerSendsPlayerCountry', resourceRoot, function(countryTable) 
    playerCountries = countryTable
end)

addEventHandler('onClientResourceStart', resourceRoot, function() 
    triggerServerEvent('onClientRequestCountryTable', resourceRoot)
end)
		...
		for player in pairs(nametags) do
			while true do
				...
				if pdistance <= NAMETAG_DISTANCE then
					...
					local countryCode = playerCountries[player] or 'naflagname'

					dxDrawImage(sx, sy - offset, 16, 11, ":admin/client/images/flags/".. countryCode ..".png", 0, 0, 0, tocolor(r, g, b, textalpha))
					-- NOTE: change string.upper to string.lower on ulti_server for lower text
					dxDrawText(getPlayerNametagText(player), sx+10, sy - offset, sx, sy - offset, tocolor(r,g,b,textalpha), textscale*NAMETAG_TEXTSIZE, "default-bold", "center", "bottom", false, false, false, true, false )
					--dxDrawRectangle(sx, sy-50, sx, 20, tocolor(0,0,0,150))
