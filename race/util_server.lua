...
addEventHandler('onPlayerJoin', root, function()
    ...
    if type(country) == 'string' then
		playerCountries[source] = string.lower(country)
        triggerClientEvent( 'onServerSendsPlayerCountry', resourceRoot, playerCountries )
    end
end)

addEventHandler('onPlayerQuit', root, function()
    if playerCountries[source] then
        playerCountries[source] = nil
        triggerClientEvent( 'onServerSendsPlayerCountry', resourceRoot, playerCountries )
    end
end)

addEvent('onClientRequestCountryTable', true)
addEventHandler('onClientRequestCountryTable', root, function()
    triggerClientEvent(client, 'onServerSendsPlayerCountry', resourceRoot, playerCountries )
end)
